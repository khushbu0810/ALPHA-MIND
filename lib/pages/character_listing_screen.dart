...
import 'package:alpha_mind/widgets/character_widget.dart';
                ...
                child: RichText(
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(text: "\n"),
                      TextSpan(
                        text: "Meet my friend Bevis!\n",
                        style: AppTheme.display2.copyWith(fontSize: 23),
                      ),
                      TextSpan(
                        text: "(by swiping right) ->",
                        style: AppTheme.display2.copyWith(fontSize: 17),
                      ),
                    ],
                  ),
                ),
