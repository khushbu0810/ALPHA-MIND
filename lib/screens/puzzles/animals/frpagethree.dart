...
import 'details_animals/owl.dart';
import 'details_animals/giraffe.dart';
import 'details_animals/zebra.dart';
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => GiraffePage()),
                      );
                    },
                    child: Container(
                      child: Image(
                        image: AssetImage('assets/giraffe.png'),
                        height: 340,
                      ),
                    ),
                  ),
